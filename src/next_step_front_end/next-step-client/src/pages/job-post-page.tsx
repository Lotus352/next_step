...
export default function JobPostPage() {
    ...
    // Redux state
    const {statuses} = useSelector((state: RootState) => state.jobs)
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                ...
                setError(e.message || "Failed to load necessary data. Please try again.")
            } finally {
                setIsLoading(false)
            }
        }
    ...
    useEffect(() => {
        ...
        if (statuses.adding === "succeeded" && mounted) {
    ...
    const renderContent = () => {
        ...
        if (error) return <TryAgain error={error}/>
                    ...
                    <CardContent className="p-0">
                        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
                            <div className="px-6 pt-6 pb-4 border-b border-border/30">
                                <TabsList
                                    className="grid grid-cols-4 w-full max-w-3xl mx-auto h-14 p-1 bg-muted/50 rounded-xl">
                                    <TabsTrigger
                                        value="details"
                            ...
                            <div className="p-6 relative overflow-hidden">
                                ...
                                >
                                    <TabsContent value="details" className="mt-0">
                                        <DetailsForm onNext={() => handleTabChange("location")}
                    ...
                    <Card className="border-border/30 bg-gradient-to-br from-muted/20 to-background shadow-lg">
                        ...
                        <CardContent>
                            <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                                ...
                                <li>List required skills in order of priority, distinguishing between must-have and
                                    nice-to-have
                                </li>

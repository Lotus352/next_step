...
import {filterUsers, resetUserFilter, setUserFilter} from "@/store/slices/users-slice.ts"
            ...
            <div className="container mx-auto px-4 py-8 relative">
                <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-8">
                    ...
                    <motion.div variants={itemVariants}
                        ...
                        {/* Total Users */}
                        {userRole === 'admin' && <Card
                            className="border-border/30 bg-background/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-300 hover:scale-105">
                            ...
                            <Card className="border-border/30 bg-background/80 backdrop-blur-sm shadow-lg">
                                <CardContent className="p-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div
                                            className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-lg border border-purple-200/50">
                                        ...
                                        <div
                                            className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-lg border border-orange-200/50">
                                            <div
                                                className="text-2xl font-bold text-orange-700">{stats.employerUsers}</div>
                                            <div className="text-sm text-orange-600 font-medium">Employers</div>
                                        </div>
                                        <div
                                            className="text-center p-4 bg-gradient-to-br from-teal-50 to-teal-100/50 rounded-lg border border-teal-200/50">
                                            <div
                                                className="text-2xl font-bold text-teal-700">{stats.candidateUsers}</div>
                    ...
                    <motion.div variants={itemVariants}>
                        <UserManagementHeader userRole={userRole} onFilterToggle={() => setShowFilters(!showFilters)}
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <UserManagementFilters userRole={userRole} filter={filter}

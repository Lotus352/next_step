...
import {fetchCertifications, setSearchKeyword} from "../../../store/slices/certifications-slice"
import {DEFAULT_LEVEL_SIZE, DEFAULT_PAGE} from "../../../constants"
import {motion} from "framer-motion"

interface CertificationManagementHeaderProps {
    onCreateNew: () => void
    onSearch: (keyword: string) => void
}

export function CertificationManagementHeader({onCreateNew, onSearch}: CertificationManagementHeaderProps) {
    const dispatch = useDispatch<AppDispatch>()
    const {statuses, searchKeyword} = useSelector((state: RootState) => state.certifications)

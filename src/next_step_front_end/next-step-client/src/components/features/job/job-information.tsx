            ...
            <div className="flex items-center p-4 border rounded-lg bg-card shadow-sm">
              ...
              <div>
                ...
                <div className="font-medium">
                  ...
                  <div className="text-xs text-muted-foreground">per {job.salary.payPeriod || "year"}</div>
                </div>
              </div>
            </div>
          )}
          ...
          {information && (
            <div className="flex items-center p-4 border rounded-lg bg-card shadow-sm">
              ...
              <div>
                ...
                <div className="font-medium">{information.expiryDate ? new Date(information.expiryDate).toLocaleDateString() : "No deadline"}</div>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="p-4 border rounded-lg bg-card shadow-sm">
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="font-medium">{job.postedBy?.username || job.postedBy?.email || "Company Recruiter"}</div>
            </div>
          </div>
        </div>
        ...
        {information?.interviewProcess && information.interviewProcess > 0 && (
          <>
            ...
            <div className="space-y-4">
              ...
              <div className="prose max-w-none">
                <p className="text-sm">This job has a {information.interviewProcess}-stage interview process.</p>
              </div>
            </div>
          </>
        )}
            ...
            <div className="space-y-4">
              ...
              <div>
                <Button variant="outline" asChild className="shadow-sm">
                  <a href={job.jobUrl} target="_blank" rel="noopener noreferrer" className="flex items-center">

...
import {JobFilters} from "@/components/features/job-filter/job-filters"
...
import {fetchEmploymentTypes, filterJobs, resetJobFilter} from "@/store/slices/jobs-slice"
import {fetchCountries} from "@/store/slices/locations-slice"
import {fetchCurrencies} from "@/store/slices/salaries-slice.ts"
import {Card} from "@/components/ui/card"
import {motion, AnimatePresence} from "framer-motion"
import {DEFAULT_JOB_SIZE, DEFAULT_SKILL_SIZE, DEFAULT_LEVEL_SIZE, DEFAULT_PAGE} from "@/constants"

export function JobListings() {
    const dispatch = useDispatch<AppDispatch>()
    const {content, totalPages, totalElements, page, filter, statuses} = useSelector((state: RootState) => state.jobs)
    ...
    return (
        <div className="relative overflow-hidden">
            ...
            <div
                className="absolute top-0 left-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
            <div
                className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[100px] translate-x-1/3 translate-y-1/3 pointer-events-none"></div>
            ...
            <span className="bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">
              Job Listings
                    ...
                    <p className="text-muted-foreground text-lg md:text-xl max-w-2xl leading-relaxed">
                        Discover thousands of opportunities from top companies worldwide. Find the perfect match for
                        your skills and
                        career goals.
                    </p>
                </motion.div>
                ...
                <div className="space-y-8">
                    ...
                    >
                        <Card
                            className="p-6 shadow-lg border-primary/10 overflow-hidden relative rounded-xl backdrop-blur-sm bg-background/80">
                            <div
                                className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent pointer-events-none"></div>
                    ...
                    >
                        ...
                        {totalPages > 0 && (
                            <div
                                className="text-sm bg-background/80 px-4 py-2 rounded-full shadow-sm border border-border/50 font-medium">
                    ...
                    {statuses.filtering === "loading" ? (
                        ...
                        >
                            ...
                            <p className="text-muted-foreground text-lg font-medium">Finding the perfect jobs for
                                you...</p>
                        </motion.div>
                    ) : content.length > 0 ? (
                        <AnimatePresence>
                        ...
                        >
                            <div
                                className="mx-auto w-20 h-20 bg-muted/50 rounded-full flex items-center justify-center mb-6 relative">
                            ...
                            <p className="text-muted-foreground mb-8 max-w-md mx-auto leading-relaxed">
                                We couldn't find any jobs matching your criteria. Try adjusting your search or filter
                                parameters.
                            </p>
                            <Button
                                variant="default"
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <Button
                                    ...
                                    disabled={page === 0 || statuses.filtering === "loading"}
                                ...
                                <Button
                                    ...
                                    disabled={page + 1 === totalPages || statuses.filtering === "loading"}
                                    className="h-10 w-10 rounded-full hover:bg-primary/10 hover:text-primary transition-colors border-border/50"

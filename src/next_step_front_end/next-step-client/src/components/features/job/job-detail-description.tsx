                ...
                <CardContent className="p-8">
                    <div className="prose prose-muted max-w-none">
                        ...
                        <div className="mb-10">
                            ...
                            <div
                                className="text-base leading-relaxed whitespace-pre-line bg-gradient-to-br from-muted/20 to-muted/10 p-6 rounded-xl border border-border/30 shadow-sm transition-all duration-300 hover:shadow-md">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                            {selected.employmentType && (
                                ...
                                >
                                    <div
                                        className="bg-gradient-to-br from-muted/20 to-muted/10 p-6 rounded-xl border border-border/30 shadow-sm hover:shadow-md transition-all duration-300">
                                        <div className="flex items-center gap-3 mb-3">
                                            <div
                                                className="p-2 bg-primary/10 rounded-lg group-hover/item:bg-primary/15 transition-colors duration-300">
                                ...
                                >
                                    ...
                                    >
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            >
                                                <Calendar
                                                    className={`h-5 w-5 ${isExpired ? "text-red-500" : "text-primary"}`}/>
                                            </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {isExpired && (
                                                <p className="text-red-600 text-sm font-medium">
                                                    This job posting has expired. Similar positions may still be
                                                    available.
                                                </p>
                                            )}
                                        </div>
                        ...
                        {selected.benefits && selected.benefits.length > 0 && (
                            <div className="mt-10">
                                ...
                                <div
                                    className="bg-gradient-to-br from-green-50/50 to-green-100/30 p-6 rounded-xl border border-green-200/50 shadow-sm transition-all duration-300 hover:shadow-md">
                                    <div className="flex flex-wrap gap-2">
                          ...
                          <span className="relative z-10 flex items-center gap-1.5">
                            <CheckCircle className="w-3 h-3 text-green-600"/>
                              {benefit}
                                                    ...
                                                    <div
                                                        className="absolute inset-0 bg-gradient-to-r from-green-100/50 to-green-200/30 opacity-0 group-hover/benefit:opacity-100 transition-opacity duration-300"/>
                                                </Badge>
                                            </div>
                                        ))}
                                    </div>

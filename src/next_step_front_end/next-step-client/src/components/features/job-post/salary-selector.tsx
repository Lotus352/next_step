...
export function SalarySelector({ onClearAll, onNext, onBack }: SalarySelectorProps) {
  ...
  useEffect(() => {
    ...
    } else if (reduxRequest.salary) {
      // Populate form with existing data if available
      setFormData({
        currency: reduxRequest.salary.currency || "",
        payPeriod: reduxRequest.salary.payPeriod || "",
        minSalary: reduxRequest.salary.minSalary || 0,
        maxSalary: reduxRequest.salary.maxSalary || 0,
      })
    }
        ...
        <CardContent className="p-6 space-y-8">
                ...
                >
                  ...
                  <SelectContent className="max-h-[300px] rounded-lg border-border/50 shadow-lg">
                    <div className="sticky top-0 bg-background p-2 border-b border-border/30 z-10">
                      <div className="text-xs font-semibold text-muted-foreground mb-1">Select a currency</div>
                    </div>
                    {currencies.length > 0 ? (
            ...
            <div className="space-y-3">
              ...
              {isLoading ? (
                ...
                >
                  ...
                  <SelectContent className="max-h-[300px] rounded-lg border-border/50 shadow-lg">
                    <div className="sticky top-0 bg-background p-2 border-b border-border/30 z-10">
                      <div className="text-xs font-semibold text-muted-foreground mb-1">Select a pay period</div>
                    </div>
                    {payPeriods.length > 0 ? (
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <Label htmlFor="minSalary" className="text-sm font-medium flex items-center justify-between">
                  <span>Minimum Salary</span>
                  {formData.currency && <span className="text-xs text-muted-foreground">{formData.currency}</span>}
                </Label>
              ...
              <div className="space-y-3">
                <Label htmlFor="maxSalary" className="text-sm font-medium flex items-center justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Job postings with salary information receive up to 40% more applications and help attract candidates

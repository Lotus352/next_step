...
export default function CompanyDescription() {
  ...
  if (!selected) return <ErrorPage message="No job selected" />
  ...
  return (
    ...
    >
      <Card className="border-primary/10 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden backdrop-blur-sm bg-white/95">
        <CardHeader className="bg-gradient-to-br from-primary/5 via-primary/3 to-transparent border-b border-primary/10 backdrop-blur-sm">
        ...
        <CardContent className="p-6">
          <div className="flex flex-col sm:flex-row sm:items-start gap-6 mb-6">
            <div className="flex-shrink-0">
              <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 300, damping: 10 }}>
                <Avatar className="h-28 w-28 border-2 border-primary/20 rounded-2xl shadow-lg">
                  ...
                  <AvatarFallback className="text-2xl font-bold rounded-2xl bg-gradient-to-br from-primary/10 to-primary/5 text-primary">
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  <ReviewStar countReview={company.countReview} averageRating={company.averageRating} />
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8 bg-gradient-to-br from-muted/10 to-muted/20 p-6 rounded-2xl border border-primary/10 shadow-inner">
            {company.founded && (

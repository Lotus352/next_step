...
import { fetchFeaturedIndustries } from "@/store/slices/industries-slice"
...
export default function FeaturedCategories() {
  ...
  if (status === "failed") return <AlertDestructive message="Failed to fetch featured categories" />
    ...
    >
      {featured.map((category, index) => {
        ...
        return (
          ...
          >
            <Card className="group overflow-hidden hover:shadow-lg transition-all duration-500 border-border/30 h-full bg-background/80 backdrop-blur-sm">
              <CardContent className="p-6 flex flex-col items-center text-center h-full">
                <div className="relative mb-5">
                  ...
                  <div className="relative h-16 w-16 flex items-center justify-center rounded-full bg-gradient-to-br from-primary/20 to-primary/5 shadow-md group-hover:shadow-lg transition-all duration-300">
                    {category.icon ? (

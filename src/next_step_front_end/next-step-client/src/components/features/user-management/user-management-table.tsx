...
import {deleteUser} from "@/store/slices/users-slice.ts"
            ...
            <motion.div initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}} className="text-center py-12">
                <Card className="border-border/30 bg-background/80 backdrop-blur-sm shadow-lg">
                    <CardContent className="p-12">
                        ...
                        <p className="text-muted-foreground text-sm">There are currently no users matching your
                            criteria.</p>
                    </CardContent>
                </Card>
            </motion.div>
                                            ...
                                            <TableCell className="py-4">
                                                <div className="flex items-center gap-3">
                                                    <Avatar className="h-10 w-10 rounded-lg">
                                                        ...
                                                        <AvatarFallback
                                                            className="bg-primary/10 text-primary font-semibold rounded-lg">
                                                    ...
                                                    <div>
                                                        ...
                                                        {user.bio && (
                                                            <div
                                                                className="text-xs text-muted-foreground line-clamp-1 mt-1">{user.bio}</div>
                                                        )}
                                                    </div>
                                                </div>
                                            </TableCell>
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    {user.phoneNumber && (
                                                        <div className="flex items-center gap-2 text-sm">
                                                            ...
                                                            <span
                                                                className="text-muted-foreground">{user.phoneNumber}</span>
                                                        </div>
                                                    )}
                                                    {user.nationality && <div
                                                        className="text-xs text-muted-foreground">{user.nationality}</div>}
                                                </div>
                                            </TableCell>

...
import {
    apply,
    checkCanWithdraw,
    checkHasApplied, deleteApplication,
...
export default function JobApplicationCard() {
    ...
    useEffect(() => {
        if (selectedJob?.jobId) {
            ...
            if (hasApplied) {
                dispatch(checkCanWithdraw(hasApplied.applicationId))
            }
        }
                ...
                <Card
                    ...
                    <CardHeader
                        ...
                        <div className="flex items-center gap-3">
                            <div className="flex-1">
                                ...
                                <CardDescription className="text-base mt-1">Submit your application and join the
                    ...
                    <CardContent className="p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            >
                                <div
                                    className="bg-gradient-to-br from-muted/20 to-muted/10 p-4 rounded-xl border border-border/30 shadow-sm hover:shadow-md transition-all duration-300">
                                    <div className="flex items-center gap-3 mb-2">
                                        <span className="text-sm font-semibold">Applicants</span>
                                    </div>
                                    <div
                                        className="text-2xl font-bold text-primary">{applicationInfo.countJobApplications}</div>
                            ...
                            {applicationInfo.interviewProcess && (
                                ...
                                >
                                    <div
                                        ...
                                        <div
                                            className="text-2xl font-bold text-primary">{applicationInfo.interviewProcess}</div>
                            ...
                            {applicationInfo.expiryDate && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`text-sm font-bold ${isExpired ? "text-red-600" : "text-primary"}`}>
                                            {isExpired
                                                ? "Expired"
                        ...
                        {isExpired && (
                            <div className="flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-red-600">This job posting is no longer accepting
                                        applications.</p>
                                </div>
                            </div>
                        )}
                    ...
                    <CardFooter
                        className="bg-muted/50 px-6 py-4 border-t transition-all duration-300 group-hover:bg-muted/70">
                        {hasApplied && canWithdraw ? (
                            ...
                            <>
                                ...
                                >
                                    ...
                                    {!isExpired && (
                                        <div
                                            className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 translate-x-[-100%] group-hover/btn:translate-x-[200%] transition-transform duration-700"/>
                                    )}
                                </Button>
                                {hasApplied && !canWithdraw && (
                ...
                <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-6 py-4">
                        ...
                        <div className="space-y-4">
                            ...
                            <RadioGroup value={resumeOption}
                                        onValueChange={(value: "existing" | "upload") => setResumeOption(value)}>
                                        ...
                                        <Label htmlFor="existing" className="flex-1 cursor-pointer">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <p className="text-sm text-muted-foreground">Resume already uploaded
                                                        to your profile</p>
                                                </div>
                                                <Button
                                                    variant="outline"
                                            ...
                                            {uploadedFile ? (
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-muted-foreground">PDF, DOC, or DOCX
                                                            up to 5MB</p>
                                                    </div>
            ...
            <Dialog open={showWithdrawDialog} onOpenChange={setShowWithdrawDialog}>
                <DialogContent className="sm:max-w-[400px]">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-base">
                            Are you sure you want to withdraw your application for {selectedJob?.title}? This action
                            cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="py-4">
                        <div className="flex items-center gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-amber-600">You will need to reapply if you change your mind
                                    later.</p>
                            </div>
                        </div>
                    </div>

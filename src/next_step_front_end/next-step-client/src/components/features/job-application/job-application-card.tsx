...
import { apply } from "@/store/slices/job-applications-slice"
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function JobApplicationCard() {
  ...
  // Redux state
  const { status, applied } = useSelector((state: RootState) => state.jobApplications)
  const { info } = useSelector((state: RootState) => state.jobApplications)
  ...
  useEffect(() => {
    if (status === "loading" && applied === true) {
      setNotification({
        isVisible: true,
        type: "info",
    ...
    } else if (status === "idle" && applied === true) {
      setNotification({
        isVisible: true,
        type: "success",
    ...
    } else if (status === "failed" && applied === true) {
      setNotification({
        isVisible: true,
        type: "error",
  ...
  return !info ? (
    ...
    <>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <Card className="border-primary/10 shadow-lg hover:shadow-xl transition-all duration-300 backdrop-blur-sm bg-white/95 overflow-hidden">
          <CardHeader className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-b border-primary/10 pb-4">
          ...
          <CardContent className="space-y-5 pt-5">
            <div className="space-y-4">
              <div className="flex items-center justify-between group transition-all duration-300 hover:translate-x-1">
                <div className="flex items-center gap-2 text-muted-foreground">
                  <Calendar className="h-4 w-4 text-primary/70 group-hover:text-primary transition-colors duration-300" />
              ...
              <div className="flex items-center justify-between group transition-all duration-300 hover:translate-x-1">
                <div className="flex items-center gap-2 text-muted-foreground">
                  <Users className="h-4 w-4 text-primary/70 group-hover:text-primary transition-colors duration-300" />
              ...
              <div className="flex items-center justify-between group transition-all duration-300 hover:translate-x-1">
                <div className="flex items-center gap-2 text-muted-foreground">
                  <Sparkles className="h-4 w-4 text-primary/70 group-hover:text-primary transition-colors duration-300" />
            ...
            <div className="bg-primary/5 p-4 rounded-xl border border-primary/10">
              <p className="text-sm text-foreground leading-relaxed">
                Apply now to join our team of talented developers building the future of technology. We're looking for
          ...
          <CardFooter className="flex flex-col space-y-3 bg-gradient-to-t from-muted/30 to-transparent pt-4">
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent className="sm:max-w-lg rounded-2xl border-primary/10 shadow-2xl backdrop-blur-sm">
                <DialogHeader>
                ...
                <div className="grid gap-5 py-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioGroup value={resumeOption} onValueChange={setResumeOption} className="space-y-3">
                      <div className="flex items-center space-x-2 p-3 rounded-lg border border-primary/10 bg-primary/5 hover:bg-primary/10 transition-colors duration-300">
            ...
            >
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
              >
                <BookmarkPlus className="h-5 w-5 transition-transform duration-300 group-hover:scale-110" />
                <span>Save Job</span>
              </motion.div>
            </Button>
          </CardFooter>
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent className="rounded-2xl border-primary/10 shadow-2xl max-w-md">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to submit your application for this position? Once submitted, you cannot edit your
              application.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

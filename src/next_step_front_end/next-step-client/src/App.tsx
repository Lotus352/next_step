...
import JobManagementPageRoute from "@/routes/job-management-page-route.tsx";
import UserManagementPageRoute from "@/routes/user-management-page-route.tsx";
import {SkillManagementPage} from "@/pages/skill-management-page.tsx";
import {CertificationManagementPage} from "@/pages/certification-management-page.tsx";
            ...
            <main className={"w-full h-full"}>
                <Router>
                    <Routes>
                        ...
                        <Route
                            path="/employer/manage-users"
                            element={
                                <ProtectedRoute allowedRoles={["employer"]}>
                                    <UserManagementPageRoute/>
                                </ProtectedRoute>
                            }
                        />

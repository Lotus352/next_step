...
CREATE TABLE `job_certifications` (
  ...
  KEY `key2_idx` (`job_id`),
  CONSTRAINT `key1` FOREIGN KEY (`certification_id`) REFERENCES `certifications` (`certification_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `jobs` VALUES (1,2,1,1,'Senior Java Developer 2','Develop high-performance backend systems','5+ years experience with Spring Boot and microservices. Must have AWS experience.','CONTRACT','https://careers.google.com/jobs/001',1,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-06-24 07:13:07',1,0,36,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(2,3,2,2,'Cloud Architect','Design Azure cloud solutions','Certified Azure Architect with 3+ years cloud migration experience.','CONTRACT','https://careers.microsoft.com/jobs/002',1,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-06-25 04:20:49',1,1,1,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(3,3,2,3,'ML Engineer','Build AI-powered mobile features','Strong Python and TensorFlow skills required. Experience with edge computing preferred.','FULL_TIME','https://careers.samsung.com/jobs/003',1,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-06-25 04:20:49',1,2,1,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(4,3,2,4,'Automation Engineer','Develop manufacturing robots','Expertise in industrial automation and CAD design. 5+ years experience.','FULL_TIME','https://www.tesla.com/careers/004',0,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-06-25 04:20:49',1,3,2,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(5,2,1,5,'Frontend Intern','Learn React development','6-month internship program for recent graduates. Basic JavaScript knowledge required.','INTERNSHIP','https://careers.google.com/jobs/005',1,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-05-23 02:33:46',1,1,3,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(6,2,1,6,'DevOps Lead','Manage Kubernetes clusters','5+ years experience with Terraform and CI/CD pipelines. AWS/GCP certification required.','FULL_TIME','https://careers.microsoft.com/jobs/006',1,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-05-29 18:14:33',1,1,4,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(7,2,1,7,'Embedded Systems Engineer','Develop IoT devices','Expertise in C/C++ and RTOS. Experience with ARM processors.','CONTRACT','https://careers.samsung.com/jobs/007',0,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-05-29 18:14:33',1,2,5,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(8,2,1,8,'Battery Engineer','Improve EV battery technology','PhD in Materials Science with 3+ years battery research experience.','FULL_TIME','https://www.tesla.com/careers/008',0,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-05-29 18:14:33',1,3,6,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(9,2,1,9,'Security Engineer','Protect cloud infrastructure','CISSP certified with 5+ years security experience. Kubernetes security knowledge required.','FULL_TIME','https://careers.google.com/jobs/009',1,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-05-23 02:33:46',1,3,7,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development'),(10,2,1,10,'Technical Writer','Create API documentation','Strong technical writing skills with OpenAPI/Swagger experience.','PART_TIME','https://careers.microsoft.com/jobs/010',1,'2025-12-30 17:00:00','OPEN',0,'2025-02-28 21:41:32','2025-05-29 18:14:33',1,3,2,'Health Insurance|Paid Leave|Year-end Bonus|Training and Development');
...
INSERT INTO `user_skills` VALUES (6,1),(7,1),(6,2),(6,3),(6,4),(6,8),(6,11),(6,12),(6,13),(6,14),(6,15),(6,16);
...
CREATE TABLE `users` (
  ...
  `is_send` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `username` (`username`),
  UNIQUE KEY `email` (`email`),
  UNIQUE KEY `phone_number_UNIQUE` (`phone_number`),
  UNIQUE KEY `bio_UNIQUE` (`bio`),
  KEY `company_id` (`company_id`),
...
INSERT INTO `users` VALUES (1,'admin1','admin@nextstep.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','Michael Johnson','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',NULL,0,'2025-02-28 21:41:32','2025-06-25 06:34:02',NULL,'0867166911','Scotland','',1),(2,'employer1','hr@google.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','Sarah Wilson','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',1,0,'2025-02-28 21:41:32','2025-06-25 06:34:43',NULL,'0867166912','Scotland',NULL,1),(3,'employer2','careers@microsoft.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','James Smith','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',2,0,'2025-02-28 21:41:32','2025-06-25 06:34:43',NULL,'0867166913','Scotland',NULL,1),(4,'employer3','recruiting@samsung.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','Ji-hoon Kim','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',3,0,'2025-02-28 21:41:32','2025-06-25 06:34:43',NULL,'0867166914','Scotland',NULL,1),(5,'employer4','hiring@tesla.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','Elon Musk','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',9,0,'2025-02-28 21:41:32','2025-06-25 06:34:43',NULL,'0867166915','Scotland',NULL,1),(6,'candidate1','john.doe@email.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','John Doe','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif','https://res.cloudinary.com/damlykdtx/raw/upload/v1747731744/cv_795ed19b-28c5-44f7-8f8d-8fd2e6f45ba5.pdf','ACTIVE',NULL,0,'2025-02-28 21:41:32','2025-06-15 15:42:44',1,'0867166916','Scotland','The brain of fruit flies and humans may be vastly different in size and complexity, but at the circuit level they are not all that different 2',1),(7,'candidate2','jane.smith@email.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','Jane Smith','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',NULL,0,'2025-02-28 21:41:32','2025-06-25 06:34:43',NULL,'0867166917','Scotland',NULL,1),(8,'candidate3','robert.brown@email.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','Robert Brown','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',NULL,0,'2025-02-28 21:41:32','2025-06-25 06:34:43',NULL,'0867166918','Scotland',NULL,1),(9,'candidate4','emily.wilson@email.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','Emily Wilson','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',NULL,0,'2025-02-28 21:41:32','2025-06-25 06:34:43',NULL,'0867166919','Scotland',NULL,1),(10,'banned1','banned@test.com','$2a$12$9jRqMOmSTh83Qe5rjyv.LeASREF3oqhRCR0swEuGjrxpQG5dkUMce','Banned User','https://cdn.vectorstock.com/i/2000v/51/87/student-avatar-user-profile-icon-vector-47025187.avif',NULL,'ACTIVE',NULL,0,'2025-02-28 21:41:32','2025-06-25 06:34:43',NULL,'0867166910','Scotland',NULL,1);
...
-- Dump completed on 2025-06-25 17:14:13
